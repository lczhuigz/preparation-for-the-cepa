...
```English
struggle    				--n&v 斗争；奋斗；挣扎；搏斗（常与 for/to/with/against 连用）
```
...
```English
thirsty						--adj 渴的；渴望的；渴求的
```

```English
courage						--n 勇气；胆量

派生：courageous				--adj 勇敢的；有勇气的
```
